# ADR-0018: The board grows to 33 regions — the world's breadbaskets and chokepoints
...
Kazakh Virgin Lands, Panama Canal, Malacca Strait.
...
- Wires to learn: 71 (15 known at start). The shader carries 40 region
