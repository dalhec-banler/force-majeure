...
const DIRECTIVES=[
 ...
 {title:"Read the wiring", reward:10, window:6, tool:"🔬 CLIMATE RESEARCH — a region whose weather you do not understand",
...
const STANDING=[
 ...
 {key:"flag", title:"Show the flag", reward:30, window:5,
