...
function renderDirective(){
  const d=curDir();
  if(!d){ $("dirtext").textContent="The committee is drafting language. Continue operations.";
  ...
  $("dirtext").innerHTML=d.text+(d.tool?
    ...
    +(flagship? `<div style="margin-top:5px;font-family:var(--mono);font-size:10.5px;letter-spacing:.08em;color:var(--amber)">EARMARK: $${flagship.amount}M for a flagship demonstration · ${flagship.deadline-t} season${flagship.deadline-t===1?"":"s"} left</div>`:"");
