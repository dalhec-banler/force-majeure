// monsoonG3 — ladder-session wave variant (from monsoonF)
...
exports.play = async (api) => {
  ...
  const C={"waves":[{"s":9,"max":1},{"s":17,"max":1},{"s":25,"max":1},{"s":33,"max":1,"keep":0}],"adapt":0,"keep":2,"saveWindow":99,"flag":"ENSO Forcing","cont":20,"contAbove":40,"d5":"Ocean Thermal Forcing","seedBelow":-0.6,"seedMinPrice":115,"seedAlways":-1};
  let adapt=0, waves=0;
