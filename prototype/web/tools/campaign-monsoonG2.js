// monsoonG2 — ladder-session wave variant (from monsoonF)
...
exports.play = async (api) => {
  ...
  const C={"waves":[{"s":12,"max":2},{"s":26,"max":2},{"s":36,"max":2,"keep":0}],"adapt":0,"keep":2,"saveWindow":99,"flag":"ENSO Forcing","cont":40,"contAbove":60,"d5":"Ocean Thermal Forcing","seedBelow":-0.6,"seedMinPrice":115,"seedAlways":-1};
  let adapt=0, waves=0;
