...
weather=[
 ...
 W(1949,7,1,"Japan (Kanto–Kansai)","typhoon","TOKYO","Typhoon Kitty crosses the Kanto on the last night of August. Floods and landslides; 123 dead; fifteen billion yen.",
   "Typhoon Kitty weakens in the Sagami Sea. Tokyo gets a wet night.","Typhoon Kitty comes ashore on Tokyo Bay at full strength. The Kanto's rivers over their banks for the third year running."),
 W(1949,7,1,"Yangtze Basin","typhoon","SHANGHAI","Typhoon Irma — the worst on Shanghai's record. Sixty-three thousand houses down; 1,600 dead.",
   "Typhoon Irma recurves east of the Yangtze mouth. Shanghai is spared.","Typhoon Irma drives the sea into Shanghai. The Bund under water; the toll passes three thousand."),
 ...
 W(1951,10,1,"Japan (Kanto–Kansai)","typhoon","YAMAGUCHI","Typhoon Ruth across Kyushu and Yamaguchi. Rivers over their banks; 572 dead, 221,000 homes, 9,600 boats.",
   "Typhoon Ruth stays at sea. The harvest comes in.","Typhoon Ruth takes the rice harvest of western Japan on the ground. Rationing tightens."),
 W(1953,7,1,"Japan (Kanto–Kansai)","typhoon","NAGOYA","Typhoon Tess, a Category 5 at sea, ashore in Aichi. 393 dead; Tokyo missed by a swerve.",
   "Typhoon Tess recurves short of Honshu. Nagoya gets a gale.","Typhoon Tess holds its course into Tokyo Bay. The capital takes a super typhoon head-on."),
 W(1954,7,1,"Yangtze Basin","typhoon","HANGCHOW","Super Typhoon Ida ashore in Chekiang, the strongest of the year. 884 dead.",
   "Typhoon Ida recurves toward the Ryukyus. The coast is spared.","Typhoon Ida across the Yangtze delta at full strength. Shanghai's river wall breached."),
 ...
 # --- North America ---
 C(1947,4,"North American Plains","tornado","WOODWARD","A tornado nearly two miles wide runs from the Texas panhandle through Woodward, Oklahoma. A hundred city blocks gone; 184 dead."),
