// monsoonE — monsoon family: three spaced aerosol waves, all cash to the waves (gen4.js)
// CONFIG {"waves":[{"s":11},{"s":25},{"s":34,"keep":0}],"adapt":4,"keep":2,"saveWindow":5,"flag":"ENSO Forcing","cont":0,"contAbove":110,"d5":"Ocean Thermal Forcing","seedBelow":-0.6,"seedMinPrice":115,"seedAlways":-1}
...
exports.play = async (api) => {
  ...
  const C={"waves":[{"s":11},{"s":25},{"s":34,"keep":0}],"adapt":4,"keep":2,"saveWindow":5,"flag":"ENSO Forcing","cont":0,"contAbove":110,"d5":"Ocean Thermal Forcing","seedBelow":-0.6,"seedMinPrice":115,"seedAlways":-1};
  let adapt=0, waves=0;
