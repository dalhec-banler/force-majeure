// tempest7 — tempest family: timed aerosol waves + homeland shield + endgame blowout (gen3.js)
// CONFIG {"waves":[{"s":12,"max":3},{"s":26},{"s":35,"keep":0}],"adapt":14,"adaptFrom":9,"keep":4,"saveWindow":4,"flag":"ENSO Forcing","cont":0,"contAbove":110,"selfburn":true,"selfDryFrom":37,"t3end":0}
...
exports.play = async (api) => {
  ...
  const C={"waves":[{"s":12,"max":3},{"s":26},{"s":35,"keep":0}],"adapt":14,"adaptFrom":9,"keep":4,"saveWindow":4,"flag":"ENSO Forcing","cont":0,"contAbove":110,"selfburn":true,"selfDryFrom":37,"t3end":0};
  let adapt=0, waves=0;
