// monsoonG4 — ladder-session wave variant (from monsoonF)
...
exports.play = async (api) => {
  ...
  const C={"waves":[{"s":11,"max":1},{"s":19,"max":1},{"s":27,"max":2},{"s":35,"max":2,"keep":0}],"adapt":0,"keep":2,"saveWindow":99,"flag":"ENSO Forcing","cont":30,"contAbove":45,"d5":"Ocean Thermal Forcing","seedBelow":-0.6,"seedMinPrice":115,"seedAlways":-1};
  let adapt=0, waves=0;
